                        ...
                        .addOnCompleteListener(Main3Activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    Toast.makeText(Main3Activity.this, "login UnSuccessfully ENTER CORRECT DETAILS", Toast.LENGTH_SHORT).show();
                                    //progressDialog.dismiss();
                                } else {
                                    Toast.makeText(Main3Activity.this, "Login Successful", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(Main3Activity.this, ShoppingActivity.class);
